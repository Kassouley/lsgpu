...
#define write_to_file(fp, v) if (fwrite(&v, sizeof(v), 1, fp) != 1) return -1;

#define write_arr_to_file(fp, v, size) if (fwrite(v, sizeof(*(v)), size, fp) != size) return -1;

#define write_str_to_file(fp, v, len) \
...
#define read_from_file(fp, v) if (fread(&v, sizeof(*(v)), 1, fp) != 1) return -1;

#define read_arr_from_file(fp, v, size) if (fread(&v, sizeof(*(v)), size, fp) != size) return -1;
...
/** String NULL-Terminated type helper */
typedef char* str;

LSGPU_HELPER_API void print_str(char* v) { printf("%s\n", v); }
LSGPU_HELPER_API int  write_str(FILE *fp, char* v) { write_str_to_file(fp, v, 128); return 0; }
LSGPU_HELPER_API int  read_str(FILE *fp, char** v) { return read_str_from_file(fp, v, 128); }
...
LSGPU_HELPER_API int  write_str64(FILE *fp, char v[64]) { write_str_to_file(fp, v, 64); return 0; }
LSGPU_HELPER_API int  read_str64(FILE *fp, char (*v)[64]) { return read_str_from_file(fp, (char**)v, 64); }
...
LSGPU_HELPER_API int  write_str21(FILE *fp, char v[21]) { write_str_to_file(fp, v, 21); return 0; }
LSGPU_HELPER_API int  read_str21(FILE *fp, char (*v)[21]) { return read_str_from_file(fp, (char**)v, 21); }
...
LSGPU_HELPER_API int  write_u32(FILE *fp, u32 v) { write_to_file(fp, v); return 0; }
LSGPU_HELPER_API int  read_u32(FILE *fp, u32 *v) { read_from_file(fp, v); return 0; }
...
LSGPU_HELPER_API int  write_u16(FILE *fp, u16 v) { write_to_file(fp, v); return 0; }
LSGPU_HELPER_API int  read_u16(FILE *fp, u16 *v) { read_from_file(fp, v); return 0; }
...
LSGPU_HELPER_API int  write_u16x3(FILE *fp, u16x3 v) { write_arr_to_file(fp, v, 3); return 0; }
LSGPU_HELPER_API int  read_u16x3(FILE *fp, u16x3 *v) { read_arr_from_file(fp, v, 3) return 0; }
...
LSGPU_HELPER_API int  write_u32x3(FILE *fp, u32x3 v) { write_arr_to_file(fp, v, 3); return 0; }
LSGPU_HELPER_API int  read_u32x3(FILE *fp, u32x3 *v) { read_arr_from_file(fp, v, 3) return 0; }
...
LSGPU_HELPER_API int  write_u32x4(FILE *fp, u32x4 v) { write_arr_to_file(fp, v, 4); return 0; }
LSGPU_HELPER_API int  read_u32x4(FILE *fp, u32x4 *v) { read_arr_from_file(fp, v, 4) return 0; }
